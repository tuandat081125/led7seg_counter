...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "MUX_FREQ" -parent ${Page_0}
...
proc update_PARAM_VALUE.MUX_FREQ { PARAM_VALUE.MUX_FREQ } {
	# Procedure called to update MUX_FREQ when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MUX_FREQ { PARAM_VALUE.MUX_FREQ } {
	# Procedure called to validate MUX_FREQ
	return true
}
...
proc update_MODELPARAM_VALUE.MUX_FREQ { MODELPARAM_VALUE.MUX_FREQ PARAM_VALUE.MUX_FREQ } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MUX_FREQ}] ${MODELPARAM_VALUE.MUX_FREQ}
}
